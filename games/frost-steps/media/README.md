...
| file | profile | 場面 |
| --- | --- | --- |
| `title.png` | `synthetic-title` | タイトル画面。氷、滑る人、クリスタル、ルーン、壁 |
| `play.png` | `synthetic-map` | 40部屋のステージマップと星の記録 |
| `clear.png` | `synthetic-first-clear` | 星3つで1部屋目をクリア |

`goal.webm`は`synthetic-first-clear`のreplayを固定エミュレータで記録した映像と音です（2.9秒、等速、音源F・D・Cの出力を混合したPCM）。
