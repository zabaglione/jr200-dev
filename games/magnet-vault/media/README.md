...
| `play.png` | `synthetic-pull` | 箱を引き寄せたあと |
| `clear.png` | `synthetic-first-clear` | 星3つで1室目をクリア |

`goal.webm`は`synthetic-first-clear`のreplayを固定エミュレータで記録した映像と音です（5.2秒、等速、音源F・D・Cの出力を混合したPCM）。
