...
| `play.png` | `synthetic-roll` | 部屋を傾けて球を転がしたあと |
| `clear.png` | `synthetic-first-clear` | 星3つで1つ目の井戸をクリア |

`goal.webm`は`synthetic-first-clear`のreplayを固定エミュレータで記録した映像と音です（3.7秒、等速、音源F・D・Cの出力を混合したPCM）。
