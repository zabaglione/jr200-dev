...
AUDIO_GAMES = ['auction-house', 'cargo-balance', 'chain-suit', 'compass-rose', 'five-forge', 'frost-steps', 'fuse-box', 'glyph-shift', 'memory-mosaic', 'mirror-relic', 'number-vault', 'orbit-draft', 'orchard-days', 'peg-garden', 'phase-pairs', 'potion-path', 'prism-trace', 'ruin-lexicon', 'shadow-archive', 'stone-balance', 'tidal-nets', 'tide-bridge', 'twenty-one', 'word-foundry']
KEYS_EXT_GAMES = ['compass-rose', 'frost-steps', 'glyph-shift', 'mirror-relic']
RANKED_GAMES = ['frost-steps', 'glyph-shift']
