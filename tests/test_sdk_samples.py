...
AUDIO_GAMES = ['auction-house', 'cargo-balance', 'fuse-box', 'memory-mosaic', 'mirror-relic', 'number-vault', 'peg-garden', 'shadow-archive', 'stone-balance', 'tidal-nets', 'word-foundry']
